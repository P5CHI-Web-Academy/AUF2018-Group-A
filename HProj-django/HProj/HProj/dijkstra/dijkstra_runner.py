...
def get_edges(encoded_path, carriage_type=None, cost_function=None):
...
def dijkstra_sample():
    edges = get_edges_from_url('https://raw.githubusercontent.com/P5CHI-Web-Academy/AUF2018-Group-A/master/stand-alone-project/parsing_filters/file.json', carriage_type=None, cost_function=None)

    covered_edges = dijkstra(edges, "#1", "#5")
    return dijkstra_dict(covered_edges, "sample")

def dijkstra_dict(covered_edges, path):
    edges_dict_list = []
